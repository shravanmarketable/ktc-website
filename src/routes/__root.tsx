...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.keralatraderscarnival.com/" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.keralatraderscarnival.com/og-img.jpg" },
      { property: "og:image:secure_url", content: "https://www.keralatraderscarnival.com/og-img.jpg" },
      ...
      { name: "twitter:image", content: "https://www.keralatraderscarnival.com/og-img.jpg" },
    ],
    links: [
      {
        rel: "icon",
